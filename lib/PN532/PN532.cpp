/**************************************************************************
    ...
    Implemented the correct wake up procedure (sending D) instead of sending getFirmwareVersion.
...
**************************************************************************/
bool PN532::ReadPassiveTargetIDB(byte* u8_UidBuffer, byte* pu8_UidLength)
{
    if (mu8_DebugLevel > 0) Utils::Print("\r\n*** ReadPassiveTargetID()\r\n");
    ...
    mu8_PacketBuffer[2] = CARD_TYPE_106KB_ISO14443B; // This function currently does not support other card types.
    mu8_PacketBuffer[3] = 0x0;
    mu8_PacketBuffer[4] = 0x1;
